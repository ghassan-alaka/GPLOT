...
VODV = data[:,9].astype('float')
TMPM = data[:,10].astype('float')
TDPM = data[:,11].astype('float')
TMVM = data[:,12].astype('float')
TDVM = data[:,13].astype('float')
TMPD = data[:,14].astype('float')
TDPD = data[:,15].astype('float')
TMVD = data[:,16].astype('float')
TDVD = data[:,17].astype('float')
PWEI = data[:,18].astype('float')
PSTI = data[:,19].astype('float')
PSHI = data[:,20].astype('float')
PMOI = data[:,21].astype('float')
PDEI = data[:,22].astype('float')
PWEO = data[:,23].astype('float')
PSTO = data[:,24].astype('float')
PSHO = data[:,25].astype('float')
PMOO = data[:,26].astype('float')
PDEO = data[:,27].astype('float')
CLST = data[:,28].astype('float')
CLSH = data[:,29].astype('float')
CLMO = data[:,30].astype('float')
CLDE = data[:,31].astype('float')
SRW1 = data[:,32].astype('float')
SRWA = data[:,33].astype('float')
SWW1 = data[:,34].astype('float')
SWWA = data[:,35].astype('float')
SLMS = data[:,36].astype('float')
SLDS = data[:,37].astype('float')
SLMM = data[:,38].astype('float')
SLDM = data[:,39].astype('float')
SLMD = data[:,40].astype('float')
SLDD = data[:,41].astype('float')
