...
def skewTmodelTCpolar(r_grid, theta_grid, p_sounding_polar, u_sounding_polar, v_sounding_polar, temp_sounding_polar, rh_sounding_polar, \
  ...
  # Produce average soundings within 50 nmi of the storm center in each quadrant,
  # taking RMW into account.
  if rmw >= 50 or rmw is np.nan:
    # Produce blank plots if RMW >= 50 or is RMW = NaN
    ...
    # Produce soundings from the RMW to 50 nmi
  ...
  # Produce averaged soundings from 50-100 nmi in each quadrant
  ...
  # Produce averaged soundings from 100-150 nmi in each quadrant
  ...
  # Produce averaged soundings from 150-200 nmi in each quadrant
