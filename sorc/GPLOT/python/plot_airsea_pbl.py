...
def main():
	...
	for (FILE,fff) in zip(UNPLOTTED_LIST,np.array(range(UNPLOTTED_LIST.size))):
		...
		if (figuretest < 1):
			...
			if (gribfiletest < 1):
				...
				'''
				print(f'MSG: Doing Height Coordinate Interpolation Now {datetime.now()}')
				...
				#Do interpolation
				print(f'MSG: Doing the Airsea Interpolation Now {datetime.now()}')
				...
				structurefile = ODIR+'/'+LONGSID.lower()+'.structure_statistics.'+forecastinit+'.airsea.f'+format(FHR,'03d')+'.txt'
				...
				if do_vt_mean == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.vt_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_w_mean == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.w_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_dbz_mean == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.dbz_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_rh_mean == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.rh_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_dbz_alongshear == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.dbz_alongshear.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_ur_alongshear == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.ur_alongshear.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_w_alongshear == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.w_alongshear.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_rh_alongshear == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.rh_alongshear.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_dbz_acrossshear == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.rh_acrossshear.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_ur_acrossshear == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.ur_acrossshear.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_w_acrossshear == 'Y':
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.w_acrossshear.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_dbz5km_wavenumber == 'Y':
					...
					# Finalize figure
					figfname = ODIR+'/'+LONGSID.lower()+'.dbz5km_wavenumber.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					#fig14.tight_layout()
				...
				if do_rh5km_wavenumber == 'Y':
					...
					# Finalize figure
					figfname = ODIR+'/'+LONGSID.lower()+'.rh5km_wavenumber.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_vt10_wavenumber == 'Y':
					...
					# Finalize figure
					figfname = ODIR+'/'+LONGSID.lower()+'.vt10_wavenumber.'+forecastinit+'.airsea.f'+format(FHR,'03d')
				...
				if do_vt_tendency == 'Y':	
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.vt_tendency_term1_mean_radial_flux_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vt_tendency_term2_mean_vertical_advection_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vt_tendency_term3_eddy_flux_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");			
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vt_tendency_term4_vertical_eddy_advection_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");			
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vt_tendency_terms_sum_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");			
				...
				if ( do_vort_tendency == 'Y'):
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vort_tendency_term1_horizontal_advection_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");			
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vort_tendency_term2_vertical_advection_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");			
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vort_tendency_term3_stretching_convergence_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");			
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vort_tendency_term4_tilting_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.vort_tendency_terms_sum_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");
				...
				if ( do_ur_pbl_p_mean == 'Y'):
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					figfname = ODIR+'/'+LONGSID.lower()+'.ur_pbl_p_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					plt.close()
					if ( DO_CONVERTGIF ):
				...
				if ( do_radar_plots == 'Y'):	
					...
					figfname = ODIR+'/'+LONGSID.lower()+'.dbz_2km_wind_5km_aircraft.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}")
					...
					plt.subplots_adjust(wspace=.25)
					figfname = ODIR+'/'+LONGSID.lower()+'.2km_reflectivity_and_precip_type_aircraft.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}")
					...
					plt.title(EXPT.strip()+'\n'+ r'Azimuthal Mean Tangential Wind ($m\ s^{-1}$, Shading)'+'\n'+'Init: '+forecastinit+' Forecast Hour:['+format(FHR,'03d')+']',fontsize=24, weight = 'bold',loc='left')
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					#plt.gcf().savefig(ODIR+'/'+LONGSID.lower()+'.vt_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')+'.png', bbox_inches='tight', dpi='figure')
					figfname = ODIR+'/'+LONGSID.lower()+'.vt_mean_aircraft.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");
					...
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					#plt.gcf().savefig(ODIR+'/'+LONGSID.lower()+'.ur_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')+'.png', bbox_inches='tight', dpi='figure')
					figfname = ODIR+'/'+LONGSID.lower()+'.ur_mean_aircraft.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}")
					...
					plt.title(EXPT.strip()+'\n'+ r'Azimuthal Mean Reflectivity ($dBZ$, Shading)'+'\n'+'Init: '+forecastinit+' Forecast Hour:['+format(FHR,'03d')+']',fontsize=24, weight = 'bold',loc='left')
					plt.title('VMAX= '+maxwind+' kt'+'\n'+'PMIN= '+minpressure+' hPa'+'\n'+LONGSID.upper(),fontsize=24,color='brown',loc='right')
					#plt.gcf().savefig(ODIR+'/'+LONGSID.lower()+'.dbz_mean.'+forecastinit+'.airsea.f'+format(FHR,'03d')+'.png', bbox_inches='tight', dpi='figure')
					figfname = ODIR+'/'+LONGSID.lower()+'.dbz_mean_aircraft.'+forecastinit+'.airsea.f'+format(FHR,'03d')
					plt.gcf().savefig(figfname+figext, bbox_inches='tight', dpi='figure')
					plt.close()
					if ( DO_CONVERTGIF ):
						os.system(f"convert {figfname}{figext} +repage gif:{figfname}.gif && /bin/rm {figfname}{figext}");
	...
	combinedfile = ODIR+'/'+LONGSID.lower()+'.structure_statistics.'+forecastinit+'.airsea.all.txt'
	pastecmd = 'paste -sd"\\n" '+ODIR+'/'+LONGSID.lower()+'.structure_statistics.'+forecastinit+'.airsea.f*.txt'+' > '+combinedfile
