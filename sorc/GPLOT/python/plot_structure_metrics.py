...
#Make plot of Rossby Number
lineplot1(xline,ROSS,'xkcd:teal',xmin,xmax,0,100,xticks,np.linspace(0,100,11),xaxislabel,'Rossby Number','Ro','Rossby Number','rossby',ysecondary,ysecondarycolor,ysecondarymin,ysecondarymax,ysecondaryticks,ysecondaryaxislabel,ysecondarylegendlabel)

#Make Plot of Warm Core Magnitude
lineplot1(xline,TMPA,'xkcd:maroon',xmin,xmax,0,20,xticks,np.linspace(0,20,11),xaxislabel,'Warm Core Anomaly (K)',r'$T_{anom}$','Warm Core Anomaly','tempanomaly',ysecondary,ysecondarycolor,ysecondarymin,ysecondarymax,ysecondaryticks,ysecondaryaxislabel,ysecondarylegendlabel)

#Make Plot of Warm Core Depth
lineplot1(xline,ZTMP,'xkcd:lime',xmin,xmax,0,18,xticks,np.linspace(0,18,10),xaxislabel,'Warm Core Height (km)',r'$Height_{tanom}$','Warm Core Height','heighttempanomaly',ysecondary,ysecondarycolor,ysecondarymin,ysecondarymax,ysecondaryticks,ysecondaryaxislabel,ysecondarylegendlabel)
...
#Make plot of dynamic vortex depth
lineplot1(xline,VODD,'xkcd:wheat',xmin,xmax,0,18,xticks,np.linspace(0,18,10),xaxislabel,'Vortex Depth (km)',r'Dynamic Vortex Depth','Dynamic Vortex Depth','vortexdepthdynamic',ysecondary,ysecondarycolor,ysecondarymin,ysecondarymax,ysecondaryticks,ysecondaryaxislabel,ysecondarylegendlabel)

#Make plot of static vortex depth
lineplot1(xline,VODS,'xkcd:dirty orange',xmin,xmax,0,18,xticks,np.linspace(0,18,10),xaxislabel,'Vortex Depth (km)',r'Static Vortex Depth','Static Vortex Depth','vortexdepthstatic',ysecondary,ysecondarycolor,ysecondarymin,ysecondarymax,ysecondaryticks,ysecondaryaxislabel,ysecondarylegendlabel)
