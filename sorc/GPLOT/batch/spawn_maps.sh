...
echo "MSG: spawn_maps.sh started at `date`"
echo "MSG: Submitting jobs for GPLOT Module 'MAPS'."
                ...
                for DMN in ${DOMAIN[@]}; do
                    ...
                    for ID in ${ENSIDS[@]}; do
                        ...
                        if [ -z "${JOB_TEST}" ]; then
                            ...
                            # Change options in the batch submission script.
                            LOG_DIR="${ODIR_FULL}"
                            LOGFILE1="${LOG_DIR}GPLOT_Maps.${EXPT}.${CYCLE}${ENSIDTAG}.${DMN}${STORMTAG}.${TR}.log"
